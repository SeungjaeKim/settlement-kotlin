...
drop table claim_receipt;
drop table order_item;
drop table order_item_snapshot;
drop table order_origin;
drop table product;
drop table seller;
drop table claim_refund_history;
drop table settlement_total;
drop table settlement_daily;
